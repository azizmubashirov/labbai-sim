...
describe('/api/files/uploads', () => {
  ...
  /** Organization-owned attachments belonged to the removed org Assistant. */
  it.each([
    { organizationId: 'org-1', contentType: 'image/png', size: 100 },
  ...
  ])('rejects organization attachments before application loading', async (body) => {
