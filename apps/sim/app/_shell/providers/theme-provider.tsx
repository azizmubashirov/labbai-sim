...
/**
 * First path segments whose pages pin the light token layer in their own
 * shell — `(auth)`, the chat interfaces, the public file view, the pages
 * reached from an email, and the credential-group handoffs. Segments, not
 * prefixes: they are matched by set membership, so `f` covers `/f/<token>` and
 ...
 */
const LIGHT_MODE_SEGMENTS: ReadonlySet<string> = new Set(LIGHT_SEGMENTS)
