/**
 * GitLab host validation for personal-token credentials. Kept after the GitLab
 * integration was removed because existing personal-token rows still resolve through it.
 */
